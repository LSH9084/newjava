...
import chap19.rentCar.window.CarSearchNum.init2;

public class CarSearchColor extends JDialog {
	JTable carTable;
	String[] columnNames = {
			"차량 번호",
			"차량 이름",
	...
	RentTableModel rm;
	String iii;
	public CarSearchColor(CarController carC, String str, String str2) {
		this.carCon = carC;
		setTitle(str);
		this.iii = str2;
	...
	public class init2{
		...
		public init2() {
			...
			if(name !=null && name.length() !=0) {
				vo2.setCar_color(name);
				try {
					carList = carcon.listCarColor(vo2);
				} catch (Exception e) {}

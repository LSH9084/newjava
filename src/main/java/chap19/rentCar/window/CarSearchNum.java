...
import chap19.rentCar.window.CarSearchD.init2;

public class CarSearchNum extends JDialog {
	JTable carTable;
	String[] columnNames = {
			"차량 번호",
			"차량 이름",
	...
	RentTableModel rm;
	String iii;
	public CarSearchNum(CarController carC, String str, String str2) {
		this.carCon = carC;
		setTitle(str);
		this.iii = str2;
